...
<div class="row">
    <div class="col-md-6 mb-4 position-sticky">
        <button class="btn btn-success mr-3" type="button" data-toggle="tooltip" title="Додати">Додати</button><a class="btn btn-danger" role="button" href="#" data-toggle="tooltip" title="Переглянути статистику по всім доступним данним">Аналітика</a>
    </div>
    <div class="col-md-6">
        <div class="form">
